...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" id="gmail"><path fill="#f2f2f2" d="m484.973 122.808-32.685 328.209H59.712L33.379 129.16 256 253.802z"></path><path fill="#f2f2f2" d="M473.886 60.983 256 265.659 38.114 60.983H256z"></path><path fill="#f14336" d="M59.712 155.493v295.524H24.139C10.812 451.017 0 440.206 0 426.878V111.967l39 1.063 20.712 42.463z"></path><path fill="#d32e2a" d="M512 111.967v314.912c0 13.327-10.812 24.139-24.152 24.139h-35.56V155.493l19.692-46.525 40.02 2.999z"></path><path fill="#f14336" d="M512 85.122v26.845l-59.712 43.526L256 298.561 59.712 155.493 0 111.967V85.122c0-13.327 10.812-24.139 24.139-24.139h13.975L256 219.792 473.886 60.983h13.962c13.34 0 24.152 10.811 24.152 24.139z"></path><path fill="#d32e2a" d="M59.712 155.493 0 146.235v-34.268z"></path></svg>
);
...
<svg xmlns="http://www.w3.org/2000/svg" width="1.6em" height="1.6em" fill-rule="evenodd" clip-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" viewBox="0 0 6.827 6.827" id="whatsapp"><g><rect width="6.827" height="6.827" fill="#2cb742" rx="1.456" ry="1.456"></rect><path fill="#fff" d="M3.316 1.416a1.987 1.987 0 0 0-1.67 2.882L1.434 5.32a.077.077 0 0 0 .093.091l1.002-.237A1.988 1.988 0 0 0 5.396 3.46a1.984 1.984 0 0 0-2.08-2.045zm1.196 3.08a1.543 1.543 0 0 1-1.099.455c-.243 0-.475-.055-.691-.163l-.14-.069-.614.145.13-.627-.07-.135a1.536 1.536 0 0 1-.168-.705A1.556 1.556 0 0 1 4.512 2.3a1.556 1.556 0 0 1 0 2.197z"></path><path fill="#fff" d="m4.376 3.827-.384-.11a.143.143 0 0 0-.142.037l-.094.096a.14.14 0 0 1-.152.032c-.182-.073-.564-.413-.662-.583a.14.14 0 0 1 .011-.156l.082-.106a.143.143 0 0 0 .018-.145l-.162-.366a.143.143 0 0 0-.223-.051c-.108.09-.235.228-.25.381-.028.27.088.609.524 1.016.505.471.909.533 1.172.47.149-.036.268-.181.343-.3a.143.143 0 0 0-.08-.215z"></path></g></svg>
);
